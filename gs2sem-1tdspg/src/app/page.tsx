  ...
  return (
    <div>
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="bg-gray-100 p-6 text-center rounded-lg shadow">
              <h3 className="text-xl font-semibold mb-3 text-verdeEscuro">Sustentabilidade</h3>
              <p>Energia 100% renovável.</p>
            </div>
            <div className="bg-gray-100 p-6 text-center rounded-lg shadow">
              <h3 className="text-xl font-semibold mb-3 text-verdeEscuro">Flexibilidade</h3>
              <p>Opções de venda e aluguel.</p>
            </div>
            <div className="bg-gray-100 p-6 text-center rounded-lg shadow">
              <h3 className="text-xl font-semibold mb-3 text-verdeEscuro">Atendimento Especializado</h3>
              <p>Soluções personalizadas para cada cliente.</p>
            </div>
            <div className="bg-gray-100 p-6 text-center rounded-lg shadow">
              <h3 className="text-xl font-semibold mb-3 text-verdeEscuro">Confiabilidade</h3>
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-6 rounded-lg shadow text-center">
              <h3 className="text-2xl font-semibold mb-4 text-verdeEscuro">Residências</h3>
            ...
            <div className="bg-white p-6 rounded-lg shadow text-center">
              <h3 className="text-2xl font-semibold mb-4 text-verdeEscuro">Empresas e Comércios</h3>
              <p>Energia confiável para seu negócio.</p>
              <a href="#" className="mt-4 inline-block bg-laranjaEscuro hover:bg-laranjaMedio text-white py-2 px-4 rounded">Ver mais</a>
            </div>
            <div className="bg-white p-6 rounded-lg shadow text-center">
              <h3 className="text-2xl font-semibold mb-4 text-verdeEEscuro">Eventos e Obras</h3>
        ...
        <div className="container mx-auto px-6 text-center">
          ...
          <div className="space-y-8">
            <blockquote className="italic text-lg">
              ...
              <br />
              <span className="font-semibold text-verdeEscuro">- Cliente Satisfeito</span>
            </blockquote>
            <blockquote className="italic text-lg">
              "Economizamos muito com os geradores solares. Ótima escolha!"
              <br />
              <span className="font-semibold text-verdeEscuro">- Maria Souza</span>
            </blockquote>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-gray-50" id="beneficios">
        <div className="container mx-auto px-6 text-center">
          <h2 className="text-3xl font-bold mb-10 text-verdeEscuro">A Energia Solar é o Futuro</h2>
      ...
      <section className="py-16 bg-laranjaEscuro text-white text-center">
        <div className="container mx-auto px-6">
          <h2 className="text-3xl font-bold mb-6">Pronto para garantir sua energia sustentável?</h2>
          <a
            href="#contato"
